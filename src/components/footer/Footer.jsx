...
function Footer() {
    ...
    return (
        ...
        <footer>
            ...
            <div>
                <ul>
                    <li><Link onClick={scrollToTop} to="/portfolio">Portfolio</Link></li>
                    <li><Link onClick={scrollToTop} to="/about-us">About Us</Link></li>
